...
public class V169_UsoThreads_II {
...
//				}
	...
	public void parar_Hilo() {
		...
		// t.stop(); //es obsoleto y no se utiliza hoy en dia

		// como tenemos un Thread.sleep(); da un error el interrupt
		// En el try catch
		t.interrupt();
