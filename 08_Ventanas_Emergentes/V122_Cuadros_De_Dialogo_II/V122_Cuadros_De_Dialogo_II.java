package V122_Cuadros_De_Dialogo_II;
...
public class V122_Cuadros_De_Dialogo_II {
	...
	private class AccionBotones implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			//	JOptionPane.showInputDialog("Introduce nombre");
				...
				JOptionPane.showConfirmDialog(Lamina.this, "Elige Opcion", "V Confirmar", 1);
				
				System.out.println("has pulsado el boton3");
				
			} else if (e.getSource() == boton4) {
				
				JOptionPane.showOptionDialog(Lamina.this, "Elige", "Titulo Ventana", 1, 1, null, null, null);
