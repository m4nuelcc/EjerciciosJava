...
class LaminaMenu extends JPanel {
	...
	LaminaMenu() {
		 ...
		 * 
		 * doce.addActionListener(new StyledEditorKit.FontSizeAction("cambiarTamaño",
		 * 12));
		 * 
		 * dieciescis.addActionListener(new
		 * StyledEditorKit.FontSizeAction("cambiarTamaño", 16));
		 * 
		 * veinte.addActionListener(new StyledEditorKit.FontSizeAction("cambiarTamaño",
		 * 20));
		 * 
		 * venticuatro.addActionListener(new
		 * StyledEditorKit.FontSizeAction("cambiarTamaño", 24));
		 * 
		 * 
		 * tamagno.add(doce);
		 * 
